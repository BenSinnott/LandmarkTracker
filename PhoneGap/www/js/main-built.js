...
define('durandal/binder',["durandal/system","knockout"],function(e,t){function n(t){return void 0===t?{applyBindings:!0}:e.isBoolean(t)?{applyBindings:t}:(void 0===t.applyBindings&&(t.applyBindings=!0),t)}function i(i,l,u,d){if(!l||!u)return r.throwOnErrors?e.error(a):e.log(a,l,d),void 0;if(!l.getAttribute)return r.throwOnErrors?e.error(o):e.log(o,l,d),void 0;var f=l.getAttribute("data-view");try{var v;return i&&i.binding&&(v=i.binding(l)),v=n(v),r.binding(d,l,v),v.applyBindings?(e.log("Binding",f,d),t.applyBindings(u,l)):i&&t.utils.domData.set(l,c,{$data:i}),r.bindingComplete(d,l,v),i&&i.bindingComplete&&i.bindingComplete(l),t.utils.domData.set(l,s,v),v}catch(g){g.message=g.message+";\nView: "+f+";\nModuleId: "+e.getModuleId(d),r.throwOnErrors?e.error(g):e.log(g.message)}}var r,a="Insufficient Information to Bind",o="Unexpected View Type",s="durandal-binding-instruction",c="__ko_bindingContext__";return r={binding:e.noop,bindingComplete:e.noop,throwOnErrors:!1,getBindingInstruction:function(e){return t.utils.domData.get(e,s)},bindContext:function(e,t,n){return n&&e&&(e=e.createChildContext(n)),i(n,t,e,n||(e?e.$data:null))},bind:function(e,t){return i(e,t,e,e)}}});
...
define('durandal/composition',["durandal/system","durandal/viewLocator","durandal/binder","durandal/viewEngine","durandal/activator","jquery","knockout"],function(e,t,n,i,r,a,o){function s(e){for(var t=[],n={childElements:t,activeView:null},i=o.virtualElements.firstChild(e);i;)1==i.nodeType&&(t.push(i),i.getAttribute(x)&&(n.activeView=i)),i=o.virtualElements.nextSibling(i);return n.activeView||(n.activeView=t[0]),n}function c(){S--,0===S&&setTimeout(function(){for(var t=I.length;t--;)try{I[t]()}catch(n){e.error(n)}I=[]},1)}function l(e){delete e.activeView,delete e.viewElements}function u(t,n,i){if(i)n();else if(t.activate&&t.model&&t.model.activate){var r;try{r=e.isArray(t.activationData)?t.model.activate.apply(t.model,t.activationData):t.model.activate(t.activationData),r&&r.then?r.then(n,function(t){e.error(t),n()}):r||void 0===r?n():(c(),l(t))}catch(a){e.error(a)}}else n()}function d(){var t=this;if(t.activeView&&t.activeView.removeAttribute(x),t.child)try{t.model&&t.model.attached&&(t.composingNewView||t.alwaysTriggerAttach)&&t.model.attached(t.child,t.parent,t),t.attached&&t.attached(t.child,t.parent,t),t.child.setAttribute(x,!0),t.composingNewView&&t.model&&t.model.detached&&o.utils.domNodeDisposal.addDisposeCallback(t.child,function(){try{t.model.detached(t.child,t.parent,t)}catch(n){e.error(n)}})}catch(n){e.error(n)}t.triggerAttach=e.noop}function f(t){if(e.isString(t.transition)){if(t.activeView){if(t.activeView==t.child)return!1;if(!t.child)return!0;if(t.skipTransitionOnSameViewId){var n=t.activeView.getAttribute("data-view"),i=t.child.getAttribute("data-view");return n!=i}}return!0}return!1}function v(e){for(var t=0,n=e.length,i=[];n>t;t++){var r=e[t].cloneNode(!0);i.push(r)}return i}function g(e){var t=v(e.parts),n=w.getParts(t,null,!0),i=w.getParts(e.child);for(var r in n)a(i[r]).replaceWith(n[r])}function p(t){var n,i,r=o.virtualElements.childNodes(t.parent);if(!e.isArray(r)){var a=[];for(n=0,i=r.length;i>n;n++)a[n]=r[n];r=a}for(n=1,i=r.length;i>n;n++)o.removeNode(r[n])}function h(e){o.utils.domData.set(e,k,e.style.display),e.style.display="none"}function m(e){e.style.display=o.utils.domData.get(e,k)}function b(e){var t=e.getAttribute("data-bind");if(!t)return!1;for(var n=0,i=_.length;i>n;n++)if(t.indexOf(_[n])>-1)return!0;return!1}var w,y={},x="data-active-view",I=[],S=0,A="durandal-composition-data",V="data-part",D=["model","view","transition","area","strategy","activationData"],k="durandal-visibility-data",_=["compose:"],N={complete:function(e){I.push(e)}};return w={composeBindings:_,convertTransitionToModuleId:function(e){return"transitions/"+e},defaultTransitionName:null,current:N,addBindingHandler:function(e,t,n){var i,r,a="composition-handler-"+e;t=t||o.bindingHandlers[e],n=n||function(){return void 0},r=o.bindingHandlers[e]={init:function(e,i,r,s,c){if(S>0){var l={trigger:o.observable(null)};w.current.complete(function(){t.init&&t.init(e,i,r,s,c),t.update&&(o.utils.domData.set(e,a,t),l.trigger("trigger"))}),o.utils.domData.set(e,a,l)}else o.utils.domData.set(e,a,t),t.init&&t.init(e,i,r,s,c);return n(e,i,r,s,c)},update:function(e,t,n,i,r){var s=o.utils.domData.get(e,a);return s.update?s.update(e,t,n,i,r):(s.trigger&&s.trigger(),void 0)}};for(i in t)"init"!==i&&"update"!==i&&(r[i]=t[i])},getParts:function(e,t,n){if(t=t||{},!e)return t;void 0===e.length&&(e=[e]);for(var i=0,r=e.length;r>i;i++){var a=e[i];if(a.getAttribute){if(!n&&b(a))continue;var o=a.getAttribute(V);o&&(t[o]=a),!n&&a.hasChildNodes()&&w.getParts(a.childNodes,t)}}return t},cloneNodes:v,finalize:function(t){if(void 0===t.transition&&(t.transition=this.defaultTransitionName),t.child||t.activeView)if(f(t)){var i=this.convertTransitionToModuleId(t.transition);e.acquire(i).then(function(e){t.transition=e,e(t).then(function(){if(t.cacheViews){if(t.activeView){var e=n.getBindingInstruction(t.activeView);e&&void 0!=e.cacheViews&&!e.cacheViews&&o.removeNode(t.activeView)}}else t.child?p(t):o.virtualElements.emptyNode(t.parent);t.triggerAttach(),c(),l(t)})}).fail(function(t){e.error("Failed to load transition ("+i+"). Details: "+t.message)})}else{if(t.child!=t.activeView){if(t.cacheViews&&t.activeView){var r=n.getBindingInstruction(t.activeView);!r||void 0!=r.cacheViews&&!r.cacheViews?o.removeNode(t.activeView):h(t.activeView)}t.child?(t.cacheViews||p(t),m(t.child)):t.cacheViews||o.virtualElements.emptyNode(t.parent)}t.triggerAttach(),c(),l(t)}else t.cacheViews||o.virtualElements.emptyNode(t.parent),t.triggerAttach(),c(),l(t)},bindAndShow:function(e,t,r){t.child=e,t.composingNewView=t.cacheViews?-1==o.utils.arrayIndexOf(t.viewElements,e):!0,u(t,function(){if(t.binding&&t.binding(t.child,t.parent,t),t.preserveContext&&t.bindingContext)t.composingNewView&&(t.parts&&g(t),h(e),o.virtualElements.prepend(t.parent,e),n.bindContext(t.bindingContext,e,t.model));else if(e){var r=t.model||y,a=o.dataFor(e);if(a!=r){if(!t.composingNewView)return o.removeNode(e),i.createView(e.getAttribute("data-view")).then(function(e){w.bindAndShow(e,t,!0)}),void 0;t.parts&&g(t),h(e),o.virtualElements.prepend(t.parent,e),n.bind(r,e)}}w.finalize(t)},r)},defaultStrategy:function(e){return t.locateViewForObject(e.model,e.area,e.viewElements)},getSettings:function(t){var n,a=t(),s=o.utils.unwrapObservable(a)||{},c=r.isActivator(a);if(e.isString(s))return s=i.isViewUrl(s)?{view:s}:{model:s,activate:!0};if(n=e.getModuleId(s))return s={model:s,activate:!0};!c&&s.model&&(c=r.isActivator(s.model));for(var l in s)s[l]=-1!=o.utils.arrayIndexOf(D,l)?o.utils.unwrapObservable(s[l]):s[l];return c?s.activate=!1:void 0===s.activate&&(s.activate=!0),s},executeStrategy:function(e){e.strategy(e).then(function(t){w.bindAndShow(t,e)})},inject:function(n){return n.model?n.view?(t.locateView(n.view,n.area,n.viewElements).then(function(e){w.bindAndShow(e,n)}),void 0):(n.strategy||(n.strategy=this.defaultStrategy),e.isString(n.strategy)?e.acquire(n.strategy).then(function(e){n.strategy=e,w.executeStrategy(n)}).fail(function(t){e.error("Failed to load view strategy ("+n.strategy+"). Details: "+t.message)}):this.executeStrategy(n),void 0):(this.bindAndShow(null,n),void 0)},compose:function(n,i,r,a){S++,a||(i=w.getSettings(function(){return i},n)),i.compositionComplete&&I.push(function(){i.compositionComplete(i.child,i.parent,i)}),I.push(function(){i.composingNewView&&i.model&&i.model.compositionComplete&&i.model.compositionComplete(i.child,i.parent,i)});var o=s(n);i.activeView=o.activeView,i.parent=n,i.triggerAttach=d,i.bindingContext=r,i.cacheViews&&!i.viewElements&&(i.viewElements=o.childElements),i.model?e.isString(i.model)?e.acquire(i.model).then(function(t){i.model=e.resolveObject(t),w.inject(i)}).fail(function(t){e.error("Failed to load composed module ("+i.model+"). Details: "+t.message)}):w.inject(i):i.view?(i.area=i.area||"partial",i.preserveContext=!0,t.locateView(i.view,i.area,i.viewElements).then(function(e){w.bindAndShow(e,i)})):this.bindAndShow(null,i)}},o.bindingHandlers.compose={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,r,a){var s=w.getSettings(t,e);if(s.mode){var c=o.utils.domData.get(e,A);if(!c){var l=o.virtualElements.childNodes(e);c={},"inline"===s.mode?c.view=i.ensureSingleElement(l):"templated"===s.mode&&(c.parts=v(l)),o.virtualElements.emptyNode(e),o.utils.domData.set(e,A,c)}"inline"===s.mode?s.view=c.view.cloneNode(!0):"templated"===s.mode&&(s.parts=c.parts),s.preserveContext=!0}w.compose(e,s,a,!0)}},o.virtualElements.allowedBindings.compose=!0,w});
...
function boot(e,t){function n(){e.title="Landmark Tracker",e.configurePlugins({router:!0}),e.start().then(function(){toastr.options.positionClass="toast-bottom-right",toastr.options.backgroundpositionClass="toast-bottom-right",t.useConvention(),e.setRoot("viewmodels/shell","entrance")})}var i=navigator.userAgent.toLowerCase();i.match(/android/)||i.match(/iphone/)||i.match(/ipad/)||i.match("ios")||i.match("Windows Phone")||i.match("iemobile")?document.addEventListener("deviceready",n,!1):n()}require.config({paths:{text:"../Scripts/text",durandal:"../Scripts/durandal",plugins:"../Scripts/durandal/plugins",transitions:"../Scripts/durandal/transitions"}}),define("jquery",[],function(){return jQuery}),define("knockout",ko),define('main',["durandal/app","durandal/viewLocator","durandal/system"],boot);
...
define('viewmodels/details',["services/logger"],function(e){function t(){var e=0;return localStorage.mount&&"NaN"!=localStorage.mount&&(e=parseInt(localStorage.mount)),e}function n(){return e.log(i+" View Activated",null,i,!0),r.count(t()),!0}var i="St Michael's Mount",r={activate:n,title:i,count:ko.observable(0)};return r.visit=function(){e.log(i+" visit recorded",null,i,!0);var n=t();n++,localStorage.mount=n,r.count(n)},r});
...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,i,r,o,a,s){function c(e){return e=e.replace(m,"\\$&").replace(g,"(?:$1)?").replace(p,function(e,t){return t?e:"([^/]+)"}).replace(h,"(.*?)"),new RegExp("^"+e+"$")}function l(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function u(e,t){return-1!==e.indexOf(t,e.length-t.length)}function d(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,i=e.length;i>n;n++)if(e[n]!=t[n])return!1;return!0}var f,v,g=/\((.*?)\)/g,p=/(\(\?)?:\w+/g,h=/\*\w+/g,m=/[\-{}\[\]+?.,\\\^$|#\s]/g,b=/\/$/,y=function(){function r(e){return e.router&&e.router.parent==P}function s(e){T&&T.config.isActive&&T.config.isActive(e)}function g(t,n){e.log("Navigation Complete",t,n);var i=e.getModuleId(D);i&&P.trigger("router:navigation:from:"+i),D=t,s(!1),T=n,s(!0);var o=e.getModuleId(D);o&&P.trigger("router:navigation:to:"+o),r(t)||P.updateDocumentTitle(t,n),v.explicitNavigation=!1,v.navigatingBack=!1,P.trigger("router:navigation:complete",t,n,P)}function p(t,n){e.log("Navigation Cancelled"),P.activeInstruction(T),T&&P.navigate(T.fragment,!1),N(!1),v.explicitNavigation=!1,v.navigatingBack=!1,P.trigger("router:navigation:cancelled",t,n,P)}function h(t){e.log("Navigation Redirecting"),N(!1),v.explicitNavigation=!1,v.navigatingBack=!1,P.navigate(t,{trigger:!0,replace:!0})}function m(t,n,i){v.navigatingBack=!v.explicitNavigation&&D!=i.fragment,P.trigger("router:route:activating",n,i,P),t.activateItem(n,i.params).then(function(e){if(e){var o=D;if(g(n,i),r(n)){var a=i.fragment;i.queryString&&(a+="?"+i.queryString),n.router.loadUrl(a)}o==n&&(P.attached(),P.compositionComplete())}else t.settings.lifecycleData&&t.settings.lifecycleData.redirect?h(t.settings.lifecycleData.redirect):p(n,i);f&&(f.resolve(),f=null)}).fail(function(t){e.error(t)})}function w(t,n,i){var r=P.guardRoute(n,i);r?r.then?r.then(function(r){r?e.isString(r)?h(r):m(t,n,i):p(n,i)}):e.isString(r)?h(r):m(t,n,i):p(n,i)}function x(e,t,n){P.guardRoute?w(e,t,n):m(e,t,n)}function I(e){return T&&T.config.moduleId==e.config.moduleId&&D&&(D.canReuseForRoute&&D.canReuseForRoute.apply(D,e.params)||!D.canReuseForRoute&&D.router&&D.router.loadUrl)}function S(){if(!N()){var t=C.shift();C=[],t&&(N(!0),P.activeInstruction(t),I(t)?x(n.create(),D,t):e.acquire(t.config.moduleId).then(function(n){var i=e.resolveObject(n);x(O,i,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)}))}}function _(e){C.unshift(e),S()}function k(e,t,n){for(var i=e.exec(t).slice(1),r=0;r<i.length;r++){var o=i[r];i[r]=o?decodeURIComponent(o):null}var a=P.parseQueryString(n);return a&&i.push(a),{params:i,queryParams:a}}function A(t){P.trigger("router:route:before-config",t,P),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||P.convertRouteToTitle(t.route),t.moduleId=t.moduleId||P.convertRouteToModuleId(t.route),t.hash=t.hash||P.convertRouteToHash(t.route),t.routePattern=c(t.route)),t.isActive=t.isActive||a.observable(!1),P.trigger("router:route:after-config",t,P),P.routes.push(t),P.route(t.routePattern,function(e,n){var i=k(t.routePattern,e,n);_({fragment:e,queryString:n,config:t,params:i.params,queryParams:i.queryParams})})}function V(t){if(e.isArray(t.route))for(var n=t.isActive||a.observable(!1),i=0,r=t.route.length;r>i;i++){var o=e.extend({},t);o.route=t.route[i],o.isActive=n,i>0&&delete o.nav,A(o)}else A(t);return P}var D,T,C=[],N=a.observable(!1),O=n.create(),P={handlers:[],routes:[],navigationModel:a.observableArray([]),activeItem:O,isNavigating:a.computed(function(){var e=O(),t=N(),n=e&&e.router&&e.router!=P&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:a.observable(null),__router__:!0};return i.includeIn(P),O.settings.areSameItem=function(e,t,n,i){return e==t?d(n,i):!1},P.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var i=0;i<n.length;i++){var r=n[i];if(""!==r){var o=r.split("=");t[o[0]]=o[1]&&decodeURIComponent(o[1].replace(/\+/g," "))}}return t},P.route=function(e,t){P.handlers.push({routePattern:e,callback:t})},P.loadUrl=function(t){var n=P.handlers,i=null,r=t,a=t.indexOf("?");if(-1!=a&&(r=t.substring(0,a),i=t.substr(a+1)),P.relativeToParentRouter){var s=this.parent.activeInstruction();r=s.params.join("/"),r&&"/"==r.charAt(0)&&(r=r.substr(1)),r||(r=""),r=r.replace("//","/").replace("//","/")}r=r.replace(b,"");for(var c=0;c<n.length;c++){var l=n[c];if(l.routePattern.test(r))return l.callback(r,i),!0}return e.log("Route Not Found"),P.trigger("router:route:not-found",t,P),T&&o.navigate(T.fragment,{trigger:!1,replace:!0}),v.explicitNavigation=!1,v.navigatingBack=!1,!1},P.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},P.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(v.explicitNavigation=!0,o.navigate(e,t))},P.navigateBack=function(){o.navigateBack()},P.attached=function(){P.trigger("router:navigation:attached",D,T,P)},P.compositionComplete=function(){N(!1),P.trigger("router:navigation:composition-complete",D,T,P),S()},P.convertRouteToHash=function(e){if(P.relativeToParentRouter){var t=P.parent.activeInstruction(),n=t.config.hash+"/"+e;return o._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return o._hasPushState?e:"#"+e},P.convertRouteToModuleId=function(e){return l(e)},P.convertRouteToTitle=function(e){var t=l(e);return t.substring(0,1).toUpperCase()+t.substring(1)},P.map=function(t,n){if(e.isArray(t)){for(var i=0;i<t.length;i++)P.map(t[i]);return P}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,V(n)},P.buildNavigationModel=function(t){for(var n=[],i=P.routes,r=t||100,o=0;o<i.length;o++){var a=i[o];a.nav&&(e.isNumber(a.nav)||(a.nav=++r),n.push(a))}return n.sort(function(e,t){return e.nav-t.nav}),P.navigationModel(n),P},P.mapUnknownRoutes=function(t,n){var i="*catchall",r=c(i);return P.route(r,function(a,s){var c=k(r,a,s),l={fragment:a,queryString:s,config:{route:i,routePattern:r},params:c.params,queryParams:c.queryParams};if(t)if(e.isString(t))l.config.moduleId=t,n&&o.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var u=t(l);if(u&&u.then)return u.then(function(){P.trigger("router:route:before-config",l.config,P),P.trigger("router:route:after-config",l.config,P),_(l)}),void 0}else l.config=t,l.config.route=i,l.config.routePattern=r;else l.config.moduleId=a;P.trigger("router:route:before-config",l.config,P),P.trigger("router:route:after-config",l.config,P),_(l)}),P},P.reset=function(){return T=D=void 0,P.handlers=[],P.routes=[],P.off(),delete P.options,P},P.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!u(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!u(t.route,"/")&&(t.route+="/"),t.fromParent&&(P.relativeToParentRouter=!0),P.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),P},P.createChildRouter=function(){var e=y();return e.parent=P,e},P};return v=y(),v.explicitNavigation=!1,v.navigatingBack=!1,v.targetIsThisWindow=function(e){var t=s(e.target).attr("target");return!t||t===window.name||"_self"===t||"top"===t&&window===window.top?!0:!1},v.activate=function(t){return e.defer(function(n){if(f=n,v.options=e.extend({routeHandler:v.loadUrl},v.options,t),o.activate(v.options),o._hasPushState)for(var i=v.routes,r=i.length;r--;){var a=i[r];a.hash=a.hash.replace("#","")}s(document).delegate("a","click",function(e){if(o._hasPushState){if(!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&v.targetIsThisWindow(e)){var t=s(this).attr("href");null==t||"#"===t.charAt(0)||/^[a-z]+:/i.test(t)||(v.explicitNavigation=!0,e.preventDefault(),o.navigate(t))}}else v.explicitNavigation=!0}),o.options.silent&&f&&(f.resolve(),f=null)}).promise()},v.deactivate=function(){o.deactivate()},v.install=function(){a.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,i,o){var s=a.utils.unwrapObservable(t())||{};if(s.__router__)s={model:s.activeItem(),attached:s.attached,compositionComplete:s.compositionComplete,activate:!1};else{var c=a.utils.unwrapObservable(s.router||i.router)||v;s.model=c.activeItem(),s.attached=c.attached,s.compositionComplete=c.compositionComplete,s.activate=!1}r.compose(e,s,o)}},a.virtualElements.allowedBindings.router=!0},v});
define('viewmodels/footer',["services/logger","plugins/router"],function(e,t){function n(){return!0}var i={activate:n};return i.navigateTo=function(e){t.navigate(e)},i});
define('plugins/dialog',["durandal/system","durandal/app","durandal/composition","durandal/activator","durandal/viewEngine","jquery","knockout"],function(e,t,n,i,r,o,a){function s(t){return e.defer(function(n){e.isString(t)?e.acquire(t).then(function(t){n.resolve(e.resolveObject(t))}).fail(function(n){e.error("Failed to load dialog module ("+t+"). Details: "+n.message)}):n.resolve(t)}).promise()}var c,l={},u=0,d=function(e,t,n){this.message=e,this.title=t||d.defaultTitle,this.options=n||d.defaultOptions};return d.prototype.selectOption=function(e){c.close(this,e)},d.prototype.getView=function(){return r.processMarkup(d.defaultViewMarkup)},d.setViewUrl=function(e){delete d.prototype.getView,d.prototype.viewUrl=e},d.defaultTitle=t.title||"Application",d.defaultOptions=["Ok"],d.defaultViewMarkup=['<div data-view="plugins/messageBox" class="messageBox">','<div class="modal-header">','<h3 data-bind="text: title"></h3>',"</div>",'<div class="modal-body">','<p class="message" data-bind="text: message"></p>',"</div>",'<div class="modal-footer" data-bind="foreach: options">','<button class="btn" data-bind="click: function () { $parent.selectOption($data); }, text: $data, css: { \'btn-primary\': $index() == 0, autofocus: $index() == 0 }"></button>',"</div>","</div>"].join("\n"),c={MessageBox:d,currentZIndex:1050,getNextZIndex:function(){return++this.currentZIndex},isOpen:function(){return u>0},getContext:function(e){return l[e||"default"]},addContext:function(e,t){t.name=e,l[e]=t;var n="show"+e.substr(0,1).toUpperCase()+e.substr(1);this[n]=function(t,n){return this.show(t,n,e)}},createCompositionSettings:function(e,t){var n={model:e,activate:!1,transition:!1};return t.attached&&(n.attached=t.attached),t.compositionComplete&&(n.compositionComplete=t.compositionComplete),n},getDialog:function(e){return e?e.__dialog__:void 0},close:function(e){var t=this.getDialog(e);if(t){var n=Array.prototype.slice.call(arguments,1);t.close.apply(t,n)}},show:function(t,r,o){var a=this,c=l[o||"default"];return e.defer(function(e){s(t).then(function(t){var o=i.create();o.activateItem(t,r).then(function(i){if(i){var r=t.__dialog__={owner:t,context:c,activator:o,close:function(){var n=arguments;o.deactivateItem(t,!0).then(function(i){i&&(u--,c.removeHost(r),delete t.__dialog__,0===n.length?e.resolve():1===n.length?e.resolve(n[0]):e.resolve.apply(e,n))})}};r.settings=a.createCompositionSettings(t,c),c.addHost(r),u++,n.compose(r.host,r.settings)}else e.resolve(!1)})})}).promise()},showMessage:function(t,n,i){return e.isString(this.MessageBox)?c.show(this.MessageBox,[t,n||d.defaultTitle,i||d.defaultOptions]):c.show(new this.MessageBox(t,n,i))},install:function(e){t.showDialog=function(e,t,n){return c.show(e,t,n)},t.showMessage=function(e,t,n){return c.showMessage(e,t,n)},e.messageBox&&(c.MessageBox=e.messageBox),e.messageBoxView&&(c.MessageBox.prototype.getView=function(){return e.messageBoxView})}},c.addContext("default",{blockoutOpacity:.2,removeDelay:200,addHost:function(e){var t=o("body"),n=o('<div class="modalBlockout"></div>').css({"z-index":c.getNextZIndex(),opacity:this.blockoutOpacity}).appendTo(t),i=o('<div class="modalHost"></div>').css({"z-index":c.getNextZIndex()}).appendTo(t);if(e.host=i.get(0),e.blockout=n.get(0),!c.isOpen()){e.oldBodyMarginRight=t.css("margin-right"),e.oldInlineMarginRight=t.get(0).style.marginRight;var r=o("html"),a=t.outerWidth(!0),s=r.scrollTop();o("html").css("overflow-y","hidden");var l=o("body").outerWidth(!0);t.css("margin-right",l-a+parseInt(e.oldBodyMarginRight,10)+"px"),r.scrollTop(s)}},removeHost:function(e){if(o(e.host).css("opacity",0),o(e.blockout).css("opacity",0),setTimeout(function(){a.removeNode(e.host),a.removeNode(e.blockout)},this.removeDelay),!c.isOpen()){var t=o("html"),n=t.scrollTop();t.css("overflow-y","").scrollTop(n),e.oldInlineMarginRight?o("body").css("margin-right",e.oldBodyMarginRight):o("body").css("margin-right","")}},attached:function(e){o(e).css("visibility","hidden")},compositionComplete:function(e,t,n){var i=c.getDialog(n.model),r=o(e),a=r.find("img").filter(function(){var e=o(this);return!(this.style.width&&this.style.height||e.attr("width")&&e.attr("height"))});r.data("predefinedWidth",r.get(0).style.width);var s=function(){setTimeout(function(){r.data("predefinedWidth")||r.css({width:""});var e=r.outerWidth(!1),t=r.outerHeight(!1),n=o(window).height(),a=Math.min(t,n);r.css({"margin-top":(-a/2).toString()+"px","margin-left":(-e/2).toString()+"px"}),r.data("predefinedWidth")||r.outerWidth(e),t>n?r.css("overflow-y","auto"):r.css("overflow-y",""),o(i.host).css("opacity",1),r.css("visibility","visible"),r.find(".autofocus").first().focus()},1)};s(),a.load(s),r.hasClass("autoclose")&&o(i.blockout).click(function(){i.close()})}}),c});
define('viewmodels/home',["plugins/dialog","plugins/router","services/logger"],function(e,t,n){function i(){var e=0;return localStorage.eden&&"NaN"!=localStorage.eden&&(e=parseInt(localStorage.eden)),e}function r(){return n.log(o+" View Activated",null,o,!0),a.count(i()),!0}var o="Eden Project",a={activate:r,title:o,count:ko.observable(0)};return a.visit=function(){n.log(o+" visit recorded",null,o,!0);var e=i();e++,localStorage.eden=e,a.count(e)},a});
define('viewmodels/pendennis',["services/logger"],function(e){function t(){var e=0;return localStorage.pendennis&&"NaN"!=localStorage.pendennis&&(e=parseInt(localStorage.pendennis)),e}function n(){return e.log(i+" View Activated",null,i,!0),r.count(t()),!0}var i="Pendennis Castle",r={activate:n,title:i,count:ko.observable(0)};return r.visit=function(){e.log(i+" visit recorded",null,i,!0);var n=t();n++,localStorage.pendennis=n,r.count(n)},r});
define('viewmodels/shell',["durandal/system","plugins/router","services/logger"],function(e,t,n){function i(){return r()}function r(){o("Landmark Tracker SPA Loaded!",null,!0),t.on("router:route:not-found",function(e){a("No Route Found",e,!0)});var e=[{route:"",moduleId:"home",title:"Home",nav:1},{route:"details",moduleId:"details",title:"Details",nav:2},{route:"pendennis",moduleId:"pendennis",title:"Pendennis",nav:3}];return t.makeRelative({moduleId:"viewmodels"}).map(e).buildNavigationModel().activate()}function o(t,i,r){n.log(t,i,e.getModuleId(s),r)}function a(t,i,r){n.logError(t,i,e.getModuleId(s),r)}var s={activate:i,router:t};return s});
define('text',{load: function(id){throw new Error("Dynamic load not allowed: " + id);}});
define('text!views/details.html',[],function () { return '<section>    \r\n    <div class="well well-sm container"><p class="pull-left visited"><span class="strong pull-left" data-bind="text: title"></span><span class="pull-left">&nbsp;</span><span class="pull-left">Visited <span data-bind="text: count"></span> times</span></p><button data-bind="click: visit" class="btn pull-right">Visit</button></div>\r\n    <div class="thumbnail">\r\n        <img src="content/images/mount.jpg"/>        \r\n    </div>\r\n    <p class="lead">\r\n        Stroll across the causeway where a legendary giant once walked. Follow the footsteps of pilgrims. Boat hop to an island where modern life meets layers of history. Discover a medieval castle, a sub-tropical paradise and a close-knit island community. Delve into the history of a fortress, a priory, a harbour and a home. \r\n        <br/>\r\n        Stray from the mainland on foot or by boat and get up close to the beguiling beauty of the castle-topped isle standing proud in Mount’s Bay. Come ashore for a family outing, a tour of the castle or a garden visit. Scale the fairytale turrets for dazzling views. Listen to live music on the village green. Tuck into fresh local food in the Island Café or the Sail Loft Restaurant.\r\n    </p>    \r\n</section>';});

define('text!views/footer.html',[],function () { return '<div id="footer">\r\n    <div class="col-xs-12 navbar-inverse navbar-fixed-bottom">\r\n        <div class="row" id="bottomNav">\r\n            <div class="col-xs-4 text-center"><a data-bind="click: navigateTo.bind($data,\'pendennis\')" href="#"><i class="glyphicon glyphicon-circle-arrow-left"></i><br>Pen</a></div>\r\n            <div class="col-xs-4 text-center"><a data-bind="click: navigateTo.bind($data,\'\')" href="#"><i class="glyphicon glyphicon-circle-arrow-down"></i><br>Edn</a></div>\r\n            <div class="col-xs-4 text-center"><a data-bind="click: navigateTo.bind($data,\'details\')" href="#"><i class="glyphicon glyphicon-circle-arrow-right"></i><br>Mnt</a></div>\r\n        </div>\r\n    </div>\r\n</div>';});
...
define('text!views/nav.html',[],function () { return '<nav role="navigation" class="navbar navbar-default">\r\n    <div class="navbar-header text-center">\r\n        <a class="navbar-brand" href="#">Landmark Tracker</a> \r\n    </div>\r\n</nav>';});

define('text!views/pendennis.html',[],function () { return '<section>\r\n    <div class="well well-sm container"><p class="pull-left visited"><span class="strong pull-left" data-bind="text: title"></span><span class="pull-left">&nbsp;</span><span class="pull-left">Visited <span data-bind="text: count"></span> times</span></p><button data-bind="click: visit" class="btn pull-right">Visit</button></div>\r\n    <div class="thumbnail">\r\n        <img src="content/images/pendennis.jpg"/>\r\n    </div>\r\n    <p class="lead">\r\n      The artillery fortress of Pendennis, and that of St Mawes, guarded the anchorage of Carrick Roads and the port of Falmouth for over 400 years. Henry VIII built a gun fort in the mid-16th century, part of a nationwide programme of defence. Bastioned defences were added in the 1590s following the threat of Spanish invasion, and tested during a siege by a Parliamentary army in 1646. The defences were then periodically updated, notably during the Napoleonic Wars, in the years 1880–1910 and during the Second World War when the guns again saw action. \r\n    </p>    \r\n</section>';});

define('text!views/shell.html',[],function () { return '<div>    \r\n    <header data-bind="compose: { view: \'nav\' }"></header>    \r\n    <article id="content" class="container" data-bind="router: { transition: \'entrance\', cacheViews: true }"></article>    \r\n    <footer data-bind="compose: {model: \'viewmodels/footer\', activate: true}"></footer>    \r\n</div>';});
